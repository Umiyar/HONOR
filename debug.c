...
static int stat_show(struct seq_file *s, void *v)
{
	...
	list_for_each_entry(si, &f2fs_stat_list, stat_list) {
		...
		seq_printf(s, "hot : count = %u, Native_info_min = %u, Native_info_max = %u\n", si->sbi->hi->counts[HOT], si->sbi->hi->Native_info_min[HOT], si->sbi->hi->Native_info_max[HOT]);
		seq_printf(s, "warm: count = %u, Native_info_min = %u, Native_info_max = %u\n", si->sbi->hi->counts[WARM], si->sbi->hi->Native_info_min[WARM], si->sbi->hi->Native_info_max[WARM]);
		seq_printf(s, "cold: count = %u, Native_info_min = %u, Native_info_max = %u\n", si->sbi->hi->counts[COLD], si->sbi->hi->Native_info_min[COLD], si->sbi->hi->Native_info_max[COLD]);
	}
